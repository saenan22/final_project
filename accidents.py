...
""")
    ...
    # 세 번째 열 (부상(건) 그래프)
        ...
        st.subheader("분석결과🔍")
        st.write("""교통사고 사건수에 대하여 최근5년간 동향을 파악해보자면 """)
        st.write("""교통사고 사망자수에 대하여 최근5년간 동향을 파악해보자면 """)
        st.write("""교통사고 부상자수에 대하여 최근5년간 동향을 파악해보자면 """)
    ...
    # 부상(명) 그래프
        ...
        st.subheader("분석결과🔍")
        st.write("""시간대별 교통사고 사건 수에 대해 분석한 결과, 저녁 6시에서 8시 사이에 가장 높은 비율로 교통사고가 발생하는 경향을 확인할 수 있었습니다.""")
        ...
        st.write("""시간대별 교통사고 부상자 수를 분석한 결과, 사건 수와 유사한 추세를 보임을 확인할 수 있었습니다. 
...
# 사고(건) 막대그래프 
       ...
       # 부상(명) 막대그래프
        ...
        st.subheader("분석결과🔍")
        st.write("""요일별 교통사고 사건수를 분석한 결과  """)
        st.write("""요일별 교통사고 사건수에대하여 말해보자면  """)
        st.write("""요일별 교통사고 사건수에대하여 말해보자면  """)
...
# 부상(건) 시각화
        ...
        st.write("""월별 교통사고 사건수에대하여 말해보자면  """)
        st.write("""월별 교통사고 사건수에대하여 말해보자면  """)
        st.write("""월별 교통사고 사건수에대하여 말해보자면  """)
...
# 부상(명) 막대그래프 및 도넛차트
        ...
        st.write("""사고유형별 교통사고 사건수에 대하여 말해보자면  """)
        st.write("""사고유형별 교통사고 사망자수에 대하여 말해보자면  """)
        st.write("""사고유형별 교통사고 부상자수에 대하여 말해보자면  """)
